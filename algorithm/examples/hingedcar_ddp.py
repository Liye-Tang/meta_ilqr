...
import numpy as np
from ddp import *
from ddp.containers import *
import matplotlib.pyplot as plt
import time

from ddp.controller import DDP
...
# a2,omiga2=action[2:]
L=50*(px1-px2)**2+50*(py1 - py2)**2+50*(heading1 - heading2)**2+5*(vel1 - vel2)**2+1*(steer1 - steer2)**2+10*(a1)**2+1*(omiga1)**2
...
plt.figure(1)
plt.plot(xs[:,0],label='DDP px',linewidth=2.5)
...
plt.figure(2)
plt.plot(xs[:,1],label='DDP py',linewidth=2.5)
...
plt.figure(3)
plt.plot(xs[:,2],label='DDP heading',linewidth=2.5)
...
plt.figure(4)
plt.plot(xs[:,3],label='DDP vel',linewidth=2.5)
...
plt.figure(5)
plt.plot(xs[:,4],label='DDP steer',linewidth=2.5)
...
plt.figure(6)
plt.plot(us[:,0],label='DDP accel',linewidth=2.5)
plt.legend(fontsize='large', loc='upper right', prop={'family': 'Times New Roman', 'size': 25})
plt.xlabel("time [s]", fontdict={'family': 'Times New Roman', 'size': 20})
plt.ylabel("accel [rad]", fontdict={'family': 'Times New Roman', 'size': 20})

plt.figure(7)
plt.plot(us[:,1],label='DDP steer_vel',linewidth=2.5)
plt.legend(fontsize='large', loc='upper right', prop={'family': 'Times New Roman', 'size': 25})
plt.xlabel("time [s]", fontdict={'family': 'Times New Roman', 'size': 20})
